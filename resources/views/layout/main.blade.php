...
<body>
    ...
    <nav class="navbar navbar-expand-lg fixed-top position-sticky mb-0 encode-sans-condensed-black fs-5 bg-secondary">
        <div class="container ms-4">
            ...
            <div class="collapse navbar-collapse justify-content-center" id="navbarNavDropdown">
                <ul class="font-color navbar-nav mt-0 text-center">
                    <li class="nav-item">
                        <img class="logo me-3 m-1" src="/storage/R.png"  width="40" alt="">
                    </li>
                        <div class="vr"></div>
                    <li class="nav-item ">
