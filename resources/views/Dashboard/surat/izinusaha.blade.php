...
<body>
  ...
  <p class="nomor"> Nomor: {{$data->id}}/01/DBB/KC//II/{{date('Y',strtotime($data->created_at))}}</p>
  <ol type="1">
    <li>Pemerintah Desa Buntu Barana dengan ini menerangkan bahwa :</li>
      ...
      <p>Orang tersebut diatas, memang benar adalah warga Desa Buntu Barana Kecamatan Curio Kabupaten Enrekang, Berdasarkan pengamatan tang telah kami lakukan memang benar yang bersangkutan mempunyai usaha</p>
