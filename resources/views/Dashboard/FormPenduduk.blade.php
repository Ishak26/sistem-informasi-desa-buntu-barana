                ...
                <div class="col-sm-6">
                    ...
                    <div class="col-sm-auto mb-1">
                        ...
                        <div class="input-group">
                            <input type="Email" name="email" class="form-control" id="validationDefaultUsername"
                                aria-describedby="inputGroupPrepend2" required value="{{ old('email') }}" />
                        </div>
                    </div>
                    <div class="col-sm-auto mb-1">
                    ...
                    <div class="col-sm-auto mb-1">
                        ...
                        <select class="form-select" name="dusun" id="validationDefault04" required>
                            <option>--Pilih--</option>
                            <option {{ old('dusun') == 'dusun1' ? 'selected' : '' }} value="dusun1">dusun 1</option>
                            <option {{ old('dusun') == 'dusun2' ? 'selected' : '' }} value="dusun2">dusun 2</option>
                            <option {{ old('dusun') == 'dusun3' ? 'selected' : '' }} value="dusun3">dusun 3</option>
                        </select>
                    </div>
                    <div class="row">
                ...
                <div class="col-sm-5 ">
                    <div class="border p-2 border-box mt-4 rounded shadow">
                        ...
                        <div class="col-sm-8 ms-3 mb-3">
                            ...
                            <input name="namasekolah" type="text" class="form-control" id="validationDefault01"
                                required value="{{ old('namasekolah') }}" />
                        </div>
                    </div>
                    <div class="border p-2 border-box mt-4 rounded shadow d-flex flex-column justify-content-center">
                        ...
                        <div class="col-sm-8 ms-3 mb-3">
                            ...
                            <input name="penghasilan" type="text" class="form-control" id="validationDefault01"
                                required value="{{ old('penghasilan') }}" />
                        </div>
                    </div>
                </div>
            </div>
