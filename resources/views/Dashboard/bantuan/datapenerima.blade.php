...
@endif
    <div class="container">
      ...
      <div class="d-flex flex-rows gap-2">
        <a href="http://" class="btn btn-bluedark"><span class="bi bi-database-fill-add align-top me-1"></span></a>  
        <a href="http://" class="btn btn-sm btn-bluedark" data-bs-toggle="modal" data-bs-target="#filterModal"><i class="bi bi-funnel-fill"></i></a>
      </div>
      <table class="table">
        <tr>
          <th scope="col">no</th>
          ...
          <form action="/dashboard/bantuan/penerima/filterpenduduk" method="post">
            ...
            <div class="d-flex flex-columns">
              <div class="col">
                ...
                <div class="row">
                  <label class="col-3" for="">Pendidikan  :</label>
                  <div class="col-9">
                    <div class="form-check form-check-inline">
                      <input class="form-check-input" type="checkbox" id="tidak sekolah" name="pendidikan[]" value="Tidak sekolah">
                      <label class="form-check-label" for="tidak sekolah">Tidak sekolah</label>
                    </div>
                    <div class="form-check form-check-inline">
                ...
                <div class="row">
                  ...
                  <div class="col-9">
                    <div class="form-check form-check-inline">
                      <input class="form-check-input" type="checkbox" id="tidak sekolah" name="status[]" value="kawin">
